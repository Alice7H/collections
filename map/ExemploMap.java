...
/*
 * Dado os modelos dos carros e seus respectivos consumos noa estrada,
 * faça:
...
public class ExemploMap {
  public static void main(String[] args) {
    ...
    // Map carrosPopulares = new HashMap(); // antes de Java 5
    ...
    for (Map.Entry<String, Double> entry : entries2) {
      if (entry.getValue().equals(consumoIneficiente)) {
        ...
        System.out.println(modeloIneficiente + " - " + consumoIneficiente);
      }
    }
    System.out.println();
    ...
    System.out.println("Confira se o dicionário 2 está vazio: " +
        carrosPopulares1.isEmpty());
    System.out.println("Confira se o dicionário 3 está vazio: " +
        carrosPopulares2.isEmpty());
  }
}
