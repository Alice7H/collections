...
class ExemploList {
  public static void main(String[] args) {
    ...
    // ArrayList<Double> notas = new ArrayList<>(); // instancia não recomendável
    // por não usar a interface

    // List<Double> notas = new ArrayList<>(Arrays.asList(7d, 8.5, 9.3, 5d, 7d, 0d,
    // 3.6));

    // forma limitada, não posso adicionar ou remover elementos nessa list
    // List<Double> notas = Arrays.asList(7d, 8.5, 9.3, 5d, 7d, 0d, 3.6);
    // notas.add(10d);
    // System.out.println(notas);

    // imutavel = não posso add ou remover
    ...
    List<Double> notas = new ArrayList<>(); // Uso do generics e diamond operator
    notas.add(7d);
    notas.add(8.5);
    notas.add(9.3);
    notas.add(5d);
